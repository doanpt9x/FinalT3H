...
public class MessagesDBManager {
    ...
    public ArrayList<MessagesOnlineItem> getData() {
        this.openDatabase();
        ArrayList<MessagesOnlineItem> messagesLogItems = new ArrayList<>();
        ...
        while (!cursor.isAfterLast()) {
            ...
            messagesLogItems.add(new MessagesOnlineItem(id, fullName, message, date, isRead));
            cursor.moveToNext();
        }
        cursor.close();
