...
import com.t3h.custom_view.TriangleShapeView;
...
public class MessageOnlineAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    private ArrayList<MessagesItem> messageItems;
    private LayoutInflater layoutInflater;
    private Bitmap inComingMessageAvatar;
    ...
    public MessageOnlineAdapter(Context context, final String inComingMessageId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        switch (type) {
            case TYPE_OUTGOING:
                viewHolder.imgTriangel.setBackgroundColor(Color.parseColor("#FFEB3B"));
                break;
            case TYPE_INCOMING:
                viewHolder.imgAvatar.setImageBitmap(inComingMessageAvatar);
                viewHolder.imgTriangel.setBackgroundColor(Color.parseColor("#80DEEA"));
                break;
        }
    ...
    public void addMessage(int position, MessagesItem messageItem) {
